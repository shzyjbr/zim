...
public enum StatusEnum {
    ...
    SERVER_NOT_AVAILABLE("7100", "zim server is not available, please try again later!"),
    ...
    REPEAT_USERNAME("4100", "The name is already in use!"),
    ERROR_USERNAME_OR_PASSWORD("4200", "Error username or password!"),
    ;
