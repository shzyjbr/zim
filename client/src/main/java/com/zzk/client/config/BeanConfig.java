...
import com.zzk.client.handle.MsgHandleCaller;
import com.zzk.client.service.impl.MsgCallBackListener;
...
//    private long userId;
    ...
    @Value("${zim.callback.thread.queue.size}")
    private int queueSize;

    @Value("${zim.callback.thread.pool.size}")
